...
if (!requerimientosError) setTotalRequerimientos(requerimientosCount || 0);
...
<h2 style={{ margin: "10px 0", color: "#111827", fontSize: isMobile ? "32px" : "38px" }}>
{totalProveedores}
</h2>
<p style={{ color: "#6b7280", marginBottom: 0 }}>Base registrada en la plataforma</p>
</div>
...
<p style={{ color: "#6b7280", marginBottom: 0 }}>Solicitudes publicadas por compradores</p>
</div>
...
<p style={{ color: "#6b7280", marginBottom: 0 }}>Flujo de cotización ya probado</p>
</div>

<div style={quickCardStyle}>
<h3 style={{ color: "#1f3552", marginTop: 0 }}>Estado</h3>
<h2 style={{ margin: "10px 0", color: "#111827", fontSize: isMobile ? "26px" : "30px" }}>
MVP activo
</h2>
<p style={{ color: "#6b7280", marginBottom: 0 }}>Estructura lista para seguir escalando</p>
</div>
</div>

<div style={sectionCardStyle}>
<h2 style={{ color: "#1f3552", marginTop: 0, fontSize: isMobile ? "24px" : "32px" }}>
¿Qué puedes hacer en PROCURO?
</h2>

<p style={{ color: "#4b5563", marginBottom: "22px", fontSize: isMobile ? "14px" : "16px" }}>
...
<h3 style={{ color: "#1f3552", marginTop: 0 }}>1. Encontrar proveedores</h3>
...
<div style={featureCardStyle}>
<h3 style={{ color: "#1f3552", marginTop: 0 }}>2. Publicar requerimientos</h3>
<p style={{ color: "#6b7280", lineHeight: 1.6 }}>
...
<div style={featureCardStyle}>
<h3 style={{ color: "#1f3552", marginTop: 0 }}>3. Comparar cotizaciones</h3>
<p style={{ color: "#6b7280", lineHeight: 1.6 }}>
